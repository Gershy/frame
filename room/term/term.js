global.rooms['term'] = async foundation => {
  ...
  let stockTerms = [
    ...
    'idol', 'idolizer', 'illuminator', 'improvement', 'inamorata', 'inamorato',
    'individual', 'indophile', 'industrialist', 'infant', 'influence', 'influential',
    'inheritor', 'initiator', 'innocent', 'innovator', 'inspiration', 'inspirer',
    'inspiriter', 'institutor', 'intellect', 'intellectual', 'intelligentsia', 'intimate',
    'introducer', 'inventor', 'invitee', 'inviter', 'jazzophile', 'keeper', 'key',
    'kingpin', 'knight', 'lady', 'lamb', 'latinophile', 'latitudinarian', 'laureate',
  ...
  let TermBank = U.form({ name: 'TermBank', props: (forms, Form) => ({
